...
if __name__ == "__main__":
    ...
    run_name = f"{env_id}_{seed}_{today.day}_{datetime.datetime.now().hour}h{datetime.datetime.now().minute}m_{total_timesteps}_newPPO_newNet_light_10hiddenunits"
    num_steps = 128
    minibatches = 4
