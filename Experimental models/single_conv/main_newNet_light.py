...
if __name__ == "__main__":
    ...
    run_name = f"{env_id}_{seed}_{today.day}_{datetime.datetime.now().hour}h{datetime.datetime.now().minute}m_{total_timesteps}_newNet_light"
    num_steps = 128
    minibatches = 4
